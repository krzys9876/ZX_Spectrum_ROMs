uart_tx_d .equ 0F1h ; TX data (out)
uart_tx_c .equ 0F3h ; TX status (in)
uart_rx_d .equ 0F5h ; RX data (in)
uart_rx_c .equ 0F7h ; RX status (in)
...
;!!!!!!!!!!
tx_emp:	in a,(uart_tx_c) ; rzeczywisty układ
...
;	out (sio_ac),a
;	nop
;	ld a,10000100b ; no parity, 1 stop bit, 32x clock - z trybem TIMER CTC należy ustawić clock x1, czyli 00 dla bitów 7 i 6
;	out (sio_ac),a
;	nop
;	ld a,03h ;WR3
;	out (sio_ac),a
