...
serialInt:      PUSH     AF
                ...
                IN       A,(80H)
                AND      01H             ; Check if interupt due to read buffer full
...
conout1:        IN       A,(80H)         ; Status byte       
                BIT      1,A             ; Set Zero flag if still transmitting character       
                JR       Z,conout1       ; Loop until flag signals ready
                POP      AF              ; Retrieve character
                OUT      (81H),A         ; Output the character
                RET
